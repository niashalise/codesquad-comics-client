            ...
            <form className="update-comics">
                <div className="form-fields">
                    <div>
                        ...
                        <input type="text" id="title" name="title" placeholder="title value stored in database" /><br />
                </div>
                <div>
                        <br /><label htmlFor="author">Author: </label>
                        <input type="text" id="author" name="author" placeholder="author value stored in database" /><br />
                </div>
                <div>
                    <br /><label htmlFor="Publisher">Publisher: </label>
                    <select id="publisher" name="publisher">
                        ...
                        <option value="viz">VIZ Media LLC</option></select><br />
                </div>
                <div>
                    <br /><label htmlFor="genre">Genre: </label>
                    <input type="text" id="genre" name="genre" placeholder="genre data stored in database"/><br />
                </div>
                <div>
                    <br /><label htmlFor="pages">Number of pages: </label>
                    <input type="text" id="pages" name="pages" placeholder="255"/><br />
                </div>
                <div>
